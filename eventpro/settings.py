...
# Django 4.2+ uses STORAGES dict; keep legacy key for older compatibility
...
if not DEBUG:
    ...
    # Do NOT set SECURE_SSL_REDIRECT = True on Render/Heroku/Railway.
    # These platforms terminate SSL at their load balancer and forward plain
    # HTTP internally — Django redirecting to HTTPS causes an infinite loop
    # and breaks static file loading. The proxy header below is enough to
    # tell Django the original request was HTTPS.
